#Crude design of Space Invaders
#By Martin Wilkinson, AKA darkwarshadow
import turtle
import os
import math
import random
...
wn=turtle.Screen()
wn.bgcolor("black")
wn.title("Space Invaders: Last Man Standing")
...
while True:
	...
	for enemy in enemies:
		...
		#Movement of the enemy back and down
		if enemy.xcor() > 280:
